...
export const server = {
  sendForm: defineAction({
    ...
    handler: async ({name, contact, message}, ctx) => {
      ...
      const TELEGRAM_BOT_TOKEN = import.meta.env.TELEGRAM_BOT_TOKEN || ctx.locals.runtime.env.TELEGRAM_BOT_TOKEN
      const TELEGRAM_CHAT_ID = import.meta.env.TELEGRAM_CHAT_ID || ctx.locals.runtime.env.TELEGRAM_CHAT_ID
